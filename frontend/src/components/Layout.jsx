...
const navItems = [
  ...
  { to: "/app/hosting", label: "Hébergement images", icon: HardDrive, testid: "nav-hosting", roles: ["admin"] },
  ...
  { to: "/app/system", label: "Système", icon: ServerCog, testid: "nav-system", roles: ["admin"] },
];
