...
export function buildSignatureHtml(user = {}, s = {}, opts = {}) {
  ...
  const contactLines = [];
  if (phoneStr)
    contactLines.push(`<tr><td class="sf-text" style="padding:1px 0;${cstyle}"><span class="sf-accent" style="color:${color};font-weight:700;">Tél&nbsp;</span>${phoneStr}</td></tr>`);
  if (direct)
    contactLines.push(`<tr><td class="sf-text" style="padding:1px 0;${cstyle}"><span class="sf-accent" style="color:${color};font-weight:700;">Ligne directe&nbsp;</span>${direct}</td></tr>`);
  if (email)
    contactLines.push(`<tr><td class="sf-text" style="padding:1px 0;${cstyle}"><span class="sf-accent" style="color:${color};font-weight:700;">Courriel&nbsp;</span><a href="mailto:${email}" style="color:${ccolor};text-decoration:none;">${email}</a></td></tr>`);
  if (website)
    contactLines.push(`<tr><td class="sf-text" style="padding:1px 0;${cstyle}"><span class="sf-accent" style="color:${color};font-weight:700;">Web&nbsp;</span><a href="${esc(normUrl(website))}" style="color:${ccolor};text-decoration:none;" target="_blank">${esc(website.replace(/^https?:\/\//i, ""))}</a></td></tr>`);
  if (address)
  ...
  if ((banner.layout || "classic") === "modern") {
    ...
    if (email) parts.push(`<a href="mailto:${email}" style="color:${ccolor};text-decoration:none;">${email}</a>`);
    if (website) parts.push(`<a href="${esc(normUrl(website))}" style="color:${ccolor};text-decoration:none;">${esc(website.replace(/^https?:\/\//i, ""))}</a>`);
